...
import {IncreamentQty} from "../redux/cartSlice";
import {DecreamentQty} from "../redux/cartSlice";
            ...
            <div className="w[60%] h-full  flex gap-6">
                ...
                <div className="w-[40%] h-full flex flex-col gap-3">
                    ...
                    <div className="w-[110px] h-[50px] bg-slate-400 flex overflow-hidden rounded shawdow-lg font-semibold border-2 border-green-400 text-xl cursor-pointer">
                        <button className="w-[30%] h-full bg-white flex justify-center items-center text-green-400 hover:bg-gray-400 cursor-pointer"onClick={()=>{qty>1?dispatch(DecreamentQty(id)):1}}>-</button>
                        <span className="w-[40%] h-full bg-slate-200 flex justify-center items-center text-green-400">{qty}</span>
                        <button className="w-[30%] h-full bg-white text-green-400 hover:bg-gray-400 cursor-pointer " onClick={()=>{dispatch(IncreamentQty(id))}}>+</button>
                    </div>
                </div>
            </div>
